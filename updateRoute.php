  ...
  <div class="sidebar2">
    <div class="wrapper">
      <div class="registration_form">
        <div class="title">Bus Route Update/Edit</div>
        <form action="#" method="POST">
          <div class="form_wrap">
            <div class="input_wrap">
              <label for="title">Id</label>
              <input type="number" id="title" name="id" class="idclass" placeholder="id"
                value="<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>">
            </div>
            <div class="input_wrap">
              <label for="title">Departure</label>
              <input type="text" id="title" name="Via_city" placeholder="Departure" required>
            </div>
            <div class="input_wrap">
            ...
            <div class="input_wrap">
              ...
              <input type="Date" id="title" name="departure_date" placeholder="Departure Date" class="idclass" min="<?php echo date('Y-m-d'); ?>">
            </div>
            <div class="input_wrap">
