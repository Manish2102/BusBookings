...
<body>
  ...
  <div class="sidebar2">
    <h1 class="adminTopic">Transaction Record</h1>
    <?php
    ...
    while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
      ...
      <td>
        <button style="border:2px solid yellow; border-radius:7px; background-color:red;color:white;">
          <a href="updateTransactionRecivied.php?id=<?php echo $row['id']; ?>">Update</a>
        </button>
      </td>
      <td>
        <button style="border:2px solid yellow; border-radius:7px; background-color:red;color:white;">
          <a href="deleteTransactionRecivied.php?id=<?php echo $row['id']; ?>">Delete</a>
        </button>
      </td>
      </tr>
      <?php
